...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO student_tbl (uid, first_name, middle_name, last_name, ext_name, class_id, email)
            VALUES ('$uid', '$first_name', '$mid_name', '$last_name', '$ext_name', '$class_id' , '$email')";
