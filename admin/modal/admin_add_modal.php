    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header py-2 px-0">
            	<div class="row float-left ml-2"><h4 class="modal-title float-left" id="myModalLabel"><i class="fa-light fa-plus mr-1"></i>Add New Admin</h4></div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="edit" class="btn btn-success" id="addAdmin"></i>Save</a>
			</form>
            </div>
