...
const char* serverUrl = "http://192.168.254.160/iot-sat/endpoint/endpoint_out.php";
...
void sendPingToServer() {
  ...
  http.begin(String(serverUrl2) + "?ping=1"  + "&devcode=exitus");
